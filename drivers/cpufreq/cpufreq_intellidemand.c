...
#define DEF_FREQUENCY_UP_THRESHOLD_MULTICORE	(70)
#define DEF_FREQUENCY_UP_THRESHOLD_ANY_CPU_LOAD	(80)
...
static struct dbs_tuners {
	...
	.up_threshold_multi_core = DEF_FREQUENCY_UP_THRESHOLD_MULTICORE,
